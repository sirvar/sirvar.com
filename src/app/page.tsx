    ...
    <main className="md:p-24 p-8">
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="font-light text-sm text-zinc-300">
          ...
          settings, particularly in building and scaling startups to new
          heights.
        </p>
        <p className="font-light text-sm text-zinc-300">
        ...
        <Experience
          ...
          description="Building the future of user generated content by connecting top creators with e-commerce brands"
        />
        <Experience
          startYear={2022}
          endYear={2023}
